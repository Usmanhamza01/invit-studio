const CACHE="invitstudio-p-v1";
const ASSETS=["app.html","manifest.json","icon-192.png","icon-512.png",
  "assets/ivoire-gatefold.webp","assets/ivoire-cover.webp","assets/nikkah-cover.webp","assets/nikkah-fond.webp","assets/floral-fond.webp"];
